...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="odbc_scan" -DDUCKDB_OOT_EXTENSION_ODBC_SCAN_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_ODBC_SCAN_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_ODBC_SCAN_INCLUDE_PATH="$(PROJ_DIR)src/include"
